...
export const blancoDeluxeTheme: InvitationThemeV2 = {
  id: 'blanco-deluxe',
  name: 'Blanco Deluxe',
  ...
  previewImage: 'https://djztbgidfrhpkmyvhuyo.supabase.co/storage/v1/object/public/invitation-assets/backgrounds/bodas.jpg',
